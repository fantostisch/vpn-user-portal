...
<?php endforeach; ?>
<?php if ($isAdmin): ?>
<?php foreach (['connections' => $this->t('Connections'), 'users' => $this->t('Users'), 'info' => $this->t('Info'), 'stats' => $this->t('Stats'), 'messages' => $this->t('Messages'), 'log' => $this->t('Log'), 'WG' => 'WireGuard'] as $menuKey => $menuText): ?>
<?php if ($menuKey === $activeItem): ?>
    <li class="active">
<?php else: ?>
    <li>
